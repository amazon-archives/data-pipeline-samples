# Data Pipeline DynamoDB to DynamoDB Copy Sample [both src and target tables are in the same region]

## Overview

This sample shows how to build a DynamoDB Copy Activity pipeline that uses a S3 directory for temporary backup. Specifically, this sample shows copying data across two dynamodb tables in the same region.
