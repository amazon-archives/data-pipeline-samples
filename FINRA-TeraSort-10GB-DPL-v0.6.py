...
# --------------------------------------------------------------
# TeraSort 10GB Benchmark DataPipeline Script
#
...
# --------------------------------------------------------------
createResponse = datapipeline.create_pipeline(name="FINRA-TeraSort-10GB-TestID-19",
    uniqueId="FINRA-TeraSort-10GB-TestID-19",
    description="Template for launching FINRA TeraSort Benchmark Test",
    tags=[{"key":"Customer", "value": "FINRA"},
    {"key": "DPL Template","value": "FINRA-TeraSort-10GB-TestID-19"}])
